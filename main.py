...
def end_game(winning,points,moves):
    if winning:
        print('\n\nYou made it to Sycamore Hall on time! Hoooray! This is fantastic! Now you might not flunk out of college! Congratulations!')
...
def main():
    ...
    games = [
        (   'Rushing to Class!',          'rush.json',    'Wright Quadrangle',    ['Sycamore Hall'],    [])
    ]
